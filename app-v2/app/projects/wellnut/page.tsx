...
export default function WellnutPage() {
  return (
    <div className="auto-number" style={{ background: wellnutGradients.page }}>
      ...
      <HeroLayout image="/img/wellnut/vr-session.jpg" imageAlt="A student trying Wellnut in VR for the first time">
        <div>
          <p className="eyebrow eyebrow-rule">UX Researcher + Project Coordinator · Jarvis Innovation Challenge 2025</p>
          <h1 className="mt-4">Wellnut</h1>
      ...
      <SplitLayout
        ...
        right={
          <div>
            ...
            <h3 className="mt-3 font-[family-name:var(--font-display)] text-3xl md:text-4xl leading-tight text-[var(--color-ink)]">
      ...
      <GradientField gradient={wellnutGradients.indigoPink}>
        <EditorialLayout>
          <div style={{ gridColumn: "1 / 8" }}>
            <h3 className="font-[family-name:var(--font-display)] text-3xl md:text-4xl leading-tight max-w-[20ch] text-[var(--color-ink)]">
      ...
      <EditorialLayout>
        <div style={{ gridColumn: "1 / 8" }}>
          ...
          <h3 className="mt-3 font-[family-name:var(--font-display)] text-3xl md:text-4xl leading-tight max-w-[20ch] text-[var(--color-ink)]">
      ...
      <GradientField gradient={wellnutGradients.brownPurple}>
        <EditorialLayout maxWidth="1440px">
          <h3
            className="font-[family-name:var(--font-display)] text-3xl md:text-4xl leading-tight text-[var(--color-ink)]"
      ...
      <EditorialLayout>
        <div style={{ gridColumn: "1 / 13" }}>
          ...
          <h3 className="mt-3 font-[family-name:var(--font-display)] text-3xl md:text-4xl leading-tight max-w-[22ch] text-[var(--color-ink)]">
      ...
      <GalleryLayout maxWidth="1600px">
        ...
        <div style={{ gridColumn: "5 / 9", marginTop: "-8%", justifySelf: "center", zIndex: 2 }}>
          <div className="rounded-2xl px-6 py-4 max-w-[34ch]" style={tintedGlass(pink, 0.12)}>
            <p className="text-[10px] font-medium tracking-[0.2em] uppercase" style={{ color: pink }}>
              In the editor
            </p>
      ...
      >
        <div className="max-w-[36ch] rounded-2xl p-6" style={tintedGlass(accent, 0.14)}>
          ...
          <h3 className="mt-3 font-[family-name:var(--font-display)] text-3xl md:text-4xl leading-[1.02] text-[var(--color-ink)]">
      ...
      <EditorialLayout maxWidth="1440px">
        <div style={{ gridColumn: "1 / 13" }}>
          ...
          <h3 className="mt-3 font-[family-name:var(--font-display)] text-3xl md:text-4xl leading-tight max-w-[24ch] text-[var(--color-ink)]">
      ...
      <EditorialLayout>
        <ol className="flex flex-col" style={{ gridColumn: "1 / 13" }}>
          {[
            ...
            <li key={item.date} className="py-5 border-t border-[var(--rule)] first:border-t-0 grid grid-cols-1 md:grid-cols-[10rem_1fr] gap-2 md:gap-8">
              <p className="flex items-center gap-2 text-xs font-medium tracking-[0.18em] uppercase" style={{ color: item.dot }}>
      ...
      <NextProjectBand {...getNextProject("wellnut")} />
    </div>
  );
}
